...
export default function AboutPage() {
  return (
    <div className="space-y-14">
      ...
      <section className="max-w-3xl space-y-4 text-(length:--text-lede) leading-9 text-(--color-ink)">
        <p>
      ...
      <section>
        ...
        <div className="border-y border-(--color-rule-storm)">
          <div className="border-b border-(--color-rule-rain) py-5">
            <p className="font-medium">Frontend / Full-stack 프로젝트</p>
            <p className="mt-2 text-sm leading-7 text-(--color-muted-ink)">
